    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          // Icônes des réseaux sociaux et bouton contact
          Row(
            children: [
              IconButton(
                icon: const Icon(Icons.facebook),
                onPressed: () {
                  // Ajouter un lien Facebook dans les données de l’entreprise pour l’ouvrir ici
                },
              ),
              IconButton(
                icon: const Icon(Icons.camera_alt),
                onPressed: () {
                  // Ajouter un lien Instagram dans les données de l’entreprise pour l’ouvrir ici
                },
              ),
              IconButton(
                icon: const Icon(Icons.video_library),
                onPressed: () {
                  // Ajouter un lien TikTok dans les données de l’entreprise pour l’ouvrir ici
                },
              ),
              ...
              Expanded(
                child: ElevatedButton.icon(
                  onPressed: () {
                    // Action contact : définir un numéro ou une adresse e‑mail dans les données
                  },
